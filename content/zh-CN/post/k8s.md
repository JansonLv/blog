...
1. [使用kind](https://kind.sigs.k8s.io/docs/user/quick-start#creating-a-cluster)做k8s安装，也可以使用kubeadm
2. [docker内置安装](https://codechina.csdn.net/mirrors/AliyunContainerService/k8s-for-docker-desktop/-/tree/v1.21.3)
